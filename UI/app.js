...
function init() {
    ...
    dz.on("complete", function (file) {
        ...
        $.ajax({
            url: url, type: "POST", data: JSON.stringify({
                data: "test"
            }), contentType: "application/json", success: function (data, status) {
                /* 
                ...
                */
                ...
                let players = ["amitabh_bachchan", "hrithik_roshan", "kangana_ranaut", "kareena_kapoor", "kim_kardashian", "sharukh_khan", "varun_dhawan"];
